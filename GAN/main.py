...
def main():
    ...
    d_optimizer = torch.optim.Adam(model.Discriminator.parameters(), lr=config["lr"])
    g_optimizer = torch.optim.Adam(model.Generator.parameters(), lr=config["lr"])
    ...
    model_name = f"GAN_{base_name}_{config['seed']}"
